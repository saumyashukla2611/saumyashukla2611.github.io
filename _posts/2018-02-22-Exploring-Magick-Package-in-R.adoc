...
library(magick)
----
I have a set a working directory, where I have saved all the images I am going to use for this demo. You can easy set it inside R: Session -> Set Working Directory. After this, there is no need of giving absolute path.
